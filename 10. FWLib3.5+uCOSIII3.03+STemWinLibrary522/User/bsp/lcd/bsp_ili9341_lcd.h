...
选择BANK1-BORSRAM1 连接 TFT，地址范围为0X6000 0000~0X63FFFFFF
FSMC_A16 接LCD的DC(寄存器/数据选择)脚
寄存器基地址 = 0X6000 0000
RAM基地址 = 0X6002 0000 = 0X6000 0000+2^16*2 = 0X60000000 + 0X20000 = 0X60020000
当选择不同的地址线时，地址要重新计算  
****************************************************************************************/
...
#define      macILI9341_RD_APBxClock_FUN      RCC_APB2PeriphClockCmd
#define      macILI9341_RD_CLK                RCC_APB2Periph_GPIOD
#define      macILI9341_RD_PORT               GPIOD
#define      macILI9341_RD_PIN                GPIO_Pin_4

#define      macILI9341_WR_APBxClock_FUN      RCC_APB2PeriphClockCmd
#define      macILI9341_WR_CLK                RCC_APB2Periph_GPIOD
#define      macILI9341_WR_PORT               GPIOD
#define      macILI9341_WR_PIN                GPIO_Pin_5
...
#define      macILI9341_BK_PIN                GPIO_Pin_13
