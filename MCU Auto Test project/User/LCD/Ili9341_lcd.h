...
/***************** ILI934 显示屏全屏默认最大宽度和最大高度（扫描方向为1） *********************/
...
//#define      macGetGBKCode( ucBuffer, usChar )  GetGBKCode_from_sd( ucBuffer, usChar )    //定义获取中文字符字模数组的函数名，ucBuffer为存放字模数组名，usChar为中文字符（国标码）
